...
class JSONExport:
    ...
    def _convert_element(
        ...
        if k == "document":
            ...
            doc = Document()
            for page in v["body"]:
                JSONExport._convert_element(page, parent_doc=doc)
            # info
            ...
            return JSONExport._add_to_parent(
                paragraph,
                json_params=v,
                page=parent_page,
            ...
            for e in v["body"]:
                JSONExport._convert_element(e, parent_table=table)
            ...
            list = UnorderedList()
            for e in v["body"]:
                JSONExport._convert_element(e, parent_list=list)
            return JSONExport._add_to_parent(
                list,
                json_params=v,
                page=parent_page,
            ...
            shape_points = {
                ...
                "circle": LineArtFactory.fraction_of_circle(
                    shape_bounding_box, Decimal(1)
                ),
                # blob
    ...
    def convert_json_to_pdf(json_root) -> Document:
        return JSONExport._convert_element(json_root)
