...
from ptext.toolkit.structure.list.simple_bullet_list_factory import (
    SimpleBulletListFactory,
)
from ptext.toolkit.structure.list.simple_ordered_list_factory import (
    SimpleOrderedListFactory,
)
from ptext.toolkit.structure.paragraph.simple_paragraph_factory import (
