...
class DefaultDCTDecodeImageTransformer(BaseTransformer):
        ...
        return (
            ...
            and (
                ...
                or (
                    ...
                    and "DCTDecode" in object["Filter"]
                )
            )
        )
    ...
    def transform(
        ...
        try:
            ...
            logger.debug(
                "Unable to read dct-encoded image. Constructing empty image of same dimensions."
            )
