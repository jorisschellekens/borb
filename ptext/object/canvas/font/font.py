...
from ptext.object.canvas.font.cmap.cmap import CMap
from ptext.object.canvas.font.glyph_line import GlyphLine, Glyph
from ptext.object.canvas.font.latin_text_encoding import (
    StandardEncoding,
    get_encoding,
    WingDings,
)
...
class Font(DictionaryWithParentAttribute):
    ...
    def build_glyph_line(self, content) -> GlyphLine:
        ...
        glyphs = []
        # TODO : encodings are still somewhat fucked
        for b in content.get_value_bytes():
            code = b & 0xFF
            if (
