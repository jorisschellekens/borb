...
from ptext.object.canvas.color.color import Color, RGBColor
...
class ColorSpectrumExtraction(EventListener):
    ...
    def _register_color(self, amount: int, color: Color):
        mod_step = 256 / (self.maximum_number_of_colors ** (1.0 / 3))
