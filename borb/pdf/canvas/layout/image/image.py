...
class Image(LayoutElement):
    ...
    def __init__(
        ...
        super(Image, self).__init__(
            ...
            margin_left=margin_left if margin_bottom is not None else Decimal(5),
            margin_right=margin_right if margin_bottom is not None else Decimal(5),
            margin_top=margin_top if margin_bottom is not None else Decimal(5),
