...
class TableUtil:
    ...
    @staticmethod
    def from_2d_array(data: typing.List[typing.List[typing.Any]],
        ...
        for i in range(0, row_count):
            for j in range(0, col_count):
                ...
                if (i == 0 and header_row) or (j == 0 and header_col):
                    p = TableCell(Paragraph(s, font_size=Decimal(12), font="Helvetica-Bold"), background_color=HexColor("f1f3f4"))
                else:
                    p = TableCell(Paragraph(s, font_size=Decimal(12), font="Helvetica"))
                t.add(p)

        # padding
        t.set_padding_on_all_cells(Decimal(3),
                                   Decimal(3),
                                   Decimal(3),
                                   Decimal(3))
