...
logging.basicConfig(
    filename="../../logs/test-create-the-raven.log", level=logging.DEBUG
)


class TestCreateTheRaven(unittest.TestCase):
    def __init__(self, methodName="runTest"):
        super().__init__(methodName)
        self.output_dir = Path("../../output/test-create-the-raven")
