...
from borb.license.async_usage_statistics_with_fair_use_warning import (
    AsyncUsageStatisticsWithFairUseWarning,
)
...
class TestFairUseWarning(TestCase):
    ...
    def test_fair_use_warning_disabled(self):

        # set _MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET
        AsyncUsageStatisticsWithFairUseWarning.disable()
        prev_MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = (
            AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET
        )
        AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = 9
        ...
        # restore _MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET
        AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = (
            prev_MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET
        )
        ...
        assert number_of_bytes_printed == 0
    ...
    def test_fair_use_warning_50_per_minute(self):
        ...
        AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = 49
    ...
    def test_fair_use_warning_100_per_minute(self):
        ...
        AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = 99
    ...
    def test_fair_use_warning_60_invoices_per_minute(self):
        ...
        AsyncUsageStatisticsWithFairUseWarning._MAX_NUMBER_OF_DOCUMENTS_PER_BUCKET = 59
