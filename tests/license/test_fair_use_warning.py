...
class TestFairUseWarning(TestCase):
    ...
    def _build_basic_invoice(self):
        ...
        l.add(FixedColumnWidthTable(number_of_columns=2, number_of_rows=5)
              .add(Image(Path("/home/joris/Code/borb-dev/logo/borb_64.png"), width=Decimal(100), height=Decimal(100)))
              .add(Paragraph("Invoice", font_size=Decimal(30), vertical_alignment=Alignment.MIDDLE, horizontal_alignment=Alignment.RIGHT))
        ...
        l.add(FixedColumnWidthTable(number_of_columns=4, number_of_rows=7, padding_top=Decimal(30))
              .add(TableCell(Paragraph("Item", font="Helvetica-Bold"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("Quantity", font="Helvetica-Bold"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("Unit Price", font="Helvetica-Bold"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("Total", font="Helvetica-Bold"), border_right=False, border_left=False))

              .add(TableCell(Paragraph("Eggshell Camisole Top"), border_right=False, border_left=False))
              ...
              .add(TableCell(Paragraph("Cuban Collar Shirt"), border_right=False, border_left=False))
              ...
              .add(TableCell(Paragraph("Floral Cotton Dress"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("1"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("$123"), border_right=False, border_left=False))
              .add(TableCell(Paragraph("$123"), border_right=False, border_left=False))

              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph("Subtotal", font="Helvetica-Bold"), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph("$500"), border_top=False, border_right=False, border_bottom=False, border_left=False))

              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph("Tax (0%)", font="Helvetica-Bold"), border_top=False, border_right=False, border_bottom=True,border_left=False))
              .add(TableCell(Paragraph("$0"), border_top=False, border_right=False, border_bottom=True, border_left=False))

              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph(""), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph("Total", font="Helvetica-Bold"), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .add(TableCell(Paragraph("$500", font="Helvetica-Bold"), border_top=False, border_right=False, border_bottom=False, border_left=False))
              .set_padding_on_all_cells(Decimal(2), Decimal(2), Decimal(2), Decimal(2))
              )
