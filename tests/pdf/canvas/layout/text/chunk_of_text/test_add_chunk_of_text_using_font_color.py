...
class TestAddChunkOfTextUsingFontColor(TestCase):
    def test_add_chunkoftext_using_font_color_001(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a ChunkOfText to the PDF with font_color 023047"
            )
        )
    ...
    def test_add_chunkoftext_using_font_color_002(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a ChunkOfText to the PDF with font_color FFB703"
            )
        )
    ...
    def test_add_chunkoftext_using_font_color_003(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a ChunkOfText to the PDF with font_color FB8500"
            )
        )
    ...
    def test_add_chunkoftext_using_font_color_004(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a ChunkOfText to the PDF with font_color 219EBC"
            )
        )
    ...
    def test_add_chunkoftext_using_font_color_005(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a ChunkOfText to the PDF with font_color 8ECAE6"
            )
        )
