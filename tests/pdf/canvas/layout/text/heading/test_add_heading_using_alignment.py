...
class TestAddHeadingUsingAlignment(TestCase):
    ...
    def test_add_heading_align_left_top(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment LEFT and vertical alignment TOP."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_left_middle(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment LEFT and vertical alignment MIDDLE."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_left_bottom(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment LEFT and vertical alignment BOTTOM."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_centered_top(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment CENTERED and vertical alignment TOP."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_centered_middle(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment CENTERED and vertical alignment MIDDLE."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_centered_bottom(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment CENTERED and vertical alignment BOTTOM."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_right_top(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment RIGHT and vertical alignment TOP."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_right_middle(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment RIGHT and vertical alignment MIDDLE."
            )
        )
        layout.add(
            Heading(
    ...
    def test_add_heading_align_right_bottom(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Heading to the PDF with horizontal alignment RIGHT and vertical alignment BOTTOM."
            )
        )
        layout.add(
            Heading(
