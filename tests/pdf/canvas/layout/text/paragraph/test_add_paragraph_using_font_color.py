...
class TestAddParagraphUsingFontColor(TestCase):
    def test_add_paragraph_using_font_color_001(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Paragraph to the PDF with font_color 023047"
            )
        )
        layout.add(
            Paragraph(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                font_color=HexColor("023047"),
            )
        )
    ...
    def test_add_paragraph_using_font_color_002(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Paragraph to the PDF with font_color FFB703"
            )
        )
        layout.add(
            Paragraph(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                font_color=HexColor("FFB703"),
            )
        )
    ...
    def test_add_paragraph_using_font_color_003(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Paragraph to the PDF with font_color FB8500"
            )
        )
        layout.add(
            Paragraph(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                font_color=HexColor("FB8500"),
            )
        )
    ...
    def test_add_paragraph_using_font_color_004(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Paragraph to the PDF with font_color 219EBC"
            )
        )
        layout.add(
            Paragraph(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                font_color=HexColor("219EBC"),
            )
        )
    ...
    def test_add_paragraph_using_font_color_005(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Paragraph to the PDF with font_color 8ECAE6"
            )
        )
        layout.add(
            Paragraph(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                font_color=HexColor("8ECAE6"),
            )
        )
