...
class TestAddRomanNumeralOrderedList(TestCase):
    ...
    def test_add_romannumeralorderedlist(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an RomanNumeralOrderedList to a PDF."
            )
        )
        layout.add(
    ...
    def test_add_orderedlist_of_romannumeralorderedlists(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an OrderedList of RomanNumeralOrderedList to a PDF."
            )
        )
        layout.add(
            OrderedList()
    ...
    def test_add_unorderedlist_of_romannumeralorderedlists(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an UnorderedList of RomanNumeralOrderedLists to a PDF."
            )
        )
        layout.add(
            UnorderedList()
    ...
    def test_add_table_of_romannumeralorderedlists(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a Table of RomanNumeralOrderedList to a PDF."
            )
        )
        layout.add(
    ...
    def test_add_romannumeralorderedlist_using_horizontal_alignment_left(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an RomanNumeralOrderedList to a PDF, the list has horizontal alignment LEFT."
            )
        )
        layout.add(
            RomanNumeralOrderedList(horizontal_alignment=Alignment.LEFT)
            .add(Paragraph(text="Lorem Ipsum Dolor Sit Amet Consectetur Nunc"))
            .add(Paragraph(text="Ipsum"))
            .add(Paragraph(text="Dolor"))
            .add(Paragraph(text="Sit"))
    ...
    def test_add_romannumeralorderedlist_using_horizontal_alignment_centered(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an RomanNumeralOrderedList to a PDF, the list has horizontal alignment CENTERED."
            )
        )
        layout.add(
            RomanNumeralOrderedList(horizontal_alignment=Alignment.CENTERED)
            .add(Paragraph(text="Lorem Ipsum Dolor Sit Amet Consectetur Nunc"))
            .add(Paragraph(text="Ipsum"))
            .add(Paragraph(text="Dolor"))
            .add(Paragraph(text="Sit"))
    ...
    def test_add_romannumeralorderedlist_using_horizontal_alignment_right(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds an RomanNumeralOrderedList to a PDF, the list has horizontal alignment RIGHT."
            )
        )
        layout.add(
            RomanNumeralOrderedList(horizontal_alignment=Alignment.RIGHT)
            .add(Paragraph(text="Lorem Ipsum Dolor Sit Amet Consectetur Nunc"))
            .add(Paragraph(text="Ipsum"))
            .add(Paragraph(text="Dolor"))
            .add(Paragraph(text="Sit"))
