...
class TestAddFlexibleColumnWidthTable(TestCase):
    def test_add_fixed_column_width_table_2_by_3(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF."
            )
        )
        layout.add(
    ...
    def test_add_fixed_column_width_table_3_by_4(self):
        ...
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=3, number_of_rows=4)
            .add(Paragraph("Lorem"))
            .add(Paragraph("Ipsum"))
            .add(Paragraph("Dolor"))
            .add(Paragraph("Sit"))
    ...
    def test_add_fixed_column_width_table_using_horizontal_alignment_left(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF using horizontal alignment LEFT"
            )
        )
        layout.add(
    ...
    def test_add_fixed_column_width_table_using_horizontal_alignment_centered(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF using horizontal alignment CENTERED."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(
    ...
    def test_add_fixed_column_width_table_using_horizontal_alignment_right(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF  using horizontal alignment RIGHT."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(
    ...
    def test_add_fixed_column_width_table_no_borders(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF without borders."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_internal_borders(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with internal borders."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_rounded_corners(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with rounded borders."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_padding_on_all_cells(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with padding on all cells."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_even_odd_row_colors(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with even/odd row colors."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_row_span(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with row_span."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_col_span(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with col_span."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
    ...
    def test_add_fixed_column_width_table_mixed_content(self):
        ...
        layout.add(
            self.get_test_header(
                test_description="This test adds a FlexibleColumnWidthTable to a PDF with mixed content."
            )
        )
        layout.add(
            FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=3)
