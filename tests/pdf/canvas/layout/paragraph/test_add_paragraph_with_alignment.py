...
class TestAddParagraphWithAlignment(unittest.TestCase):
    """
    This test creates a PDF with a Paragraph object in it.
    The Paragraph is aligned in all possible combinations of horizontal and vertical layout.
    """
        ...
        layout.add(
            ...
            .add(
                Paragraph(
                    "This test creates a PDF with a Paragraph object in it. "
                    "The Paragraph is aligned in all possible combinations of horizontal and vertical layout. "
                    "The dark green box is the bounding box given to the layout algorithm. The actual space taken up by the paragraph is marked in light green."
                )
            )
