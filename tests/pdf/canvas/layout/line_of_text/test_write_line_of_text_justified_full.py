...
logging.basicConfig(
    filename=Path(get_log_dir(), "test-write-line-of-text-justified-full.log"),
    level=logging.DEBUG,
)


class TestWriteLineOfTextJustifiedFull(unittest.TestCase):
    def __init__(self, methodName="runTest"):
        super().__init__(methodName)
        self.output_dir = Path(
            get_output_dir(), "test-write-line-of-text-justified-full"
        )
