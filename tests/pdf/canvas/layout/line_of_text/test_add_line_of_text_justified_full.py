...
class TestAddLineOfTextJustifiedFull(unittest.TestCase):
    """
    This test creates a PDF with several LineOfText objects in it, horizontal alignment set to JUSTIFIED
    """
