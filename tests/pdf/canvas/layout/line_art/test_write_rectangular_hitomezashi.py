...
class TestWriteRectangularHitomezashi(unittest.TestCase):
    """
    ...
    def _write_shape(self, page: Page, layout: SingleColumnLayout):
    ...
    def test_write_document(self):
        ...
        layout.add(
            ...
            .add(
                Paragraph(
                    "This test creates a PDF with a rectangular Hitomezashi grid in it."
                )
            )
            .set_padding_on_all_cells(Decimal(2), Decimal(2), Decimal(2), Decimal(2))
        )

        self._write_shape(page, layout)
