...
logging.basicConfig(
    filename=Path(get_log_dir(), "test-write-chunk-of-text-escaped-chars.log"),
    level=logging.DEBUG,
)
...
class TestWriteChunkOfTextEscapedChars(unittest.TestCase):
    def __init__(self, methodName="runTest"):
        ...
        self.output_dir = Path(
            get_output_dir(), "test-write-chunk-of-text-escaped-chars"
        )
    ...
    def test_write_document(self):
        ...
        ChunkOfText("(one)\tTwo\nThree\bFour\fFive", font_size=Decimal(24),).layout(
