...
class TestAddDropDownList(TestCase):
    ...
    def test_add_dropdownlist(self):
        ...
        page_layout.add(
            self.get_test_header("This test creates a PDF with a DropDownList in it.")
        )
    ...
    def test_add_orderedlist_of_dropdownlists(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an OrderedList of DropDownLists in it."
            )
        )
        page_layout.add(
            OrderedList()
            .add(DropDownList(possible_values=["lorem", "ipsum", "dolor"]))
            .add(DropDownList(possible_values=["lorem", "ipsum", "dolor"]))
            .add(DropDownList(possible_values=["lorem", "ipsum", "dolor"]))
        )
    ...
    def test_add_unorderedlist_of_dropdownlists(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an UnorderedList of DropDownLists in it."
            )
        )
        page_layout.add(
            UnorderedList()
    ...
    def test_add_table_of_dropdownlists(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an Table of DropDownLists in it."
            )
        )
        page_layout.add(
