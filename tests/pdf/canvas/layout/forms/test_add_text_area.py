...
class TestAddTextArea(TestCase):
    ...
    def test_add_textarea(self):
        ...
        page_layout.add(
            self.get_test_header("This test creates a PDF with a TextArea in it.")
        )
    ...
    def test_add_orderedlist_of_textareas(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an OrderedList of TextAreas in it."
            )
        )
    ...
    def test_add_unorderedlist_of_textareas(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an UnorderedList of TextAreas in it."
            )
        )
    ...
    def test_add_table_of_textareas(self):
        ...
        page_layout.add(
            self.get_test_header(
                "This test creates a PDF with an Table of TextAreas in it."
            )
        )
        page_layout.add(
