...
logging.basicConfig(
    filename=Path(
        get_log_dir(), "test-write-complete-the-picture-horizontally-puzzle.log"
    ),
    level=logging.DEBUG,
)


class TestWriteCompleteThePictureHorizontallyPuzzle(unittest.TestCase):
    def __init__(self, methodName="runTest"):
        super().__init__(methodName)
        self.output_dir = Path(
            get_output_dir(), "test-write-complete-the-picture-horizontally-puzzle"
        )
