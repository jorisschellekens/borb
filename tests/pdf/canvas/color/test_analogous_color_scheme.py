...
class TestAnalogousColorScheme(unittest.TestCase):
    ...
    def test_analogous_color_scheme(self):
        ...
        l.add(
            ...
            .add(
                Paragraph(
                    "This test creates a PDF with 3 droplet shapes in it, in colors that form an analogous color group."
                )
            )
        ...
        t: FixedColumnWidthTable = FixedColumnWidthTable(
            number_of_rows=4, number_of_columns=3, padding_top=Decimal(12)
        )
