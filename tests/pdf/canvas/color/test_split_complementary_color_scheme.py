...
class TestSplitComplementaryColorScheme(unittest.TestCase):
    ...
    def test_split_complementary_color_scheme(self):
        ...
        l.add(
            ...
            .add(
                Paragraph(
                    "This test creates a PDF with 3 droplet shapes in it, in colors that form a split-complementary color group."
                )
            )
