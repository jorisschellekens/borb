...
class TestA4TwoColumnTemplate(TestCase):
    def test_add_barchart(self):
        A42ColumnPortraitTemplate().add_barchart(
            xs=[10, 20, 30, 40],
    ...
    def test_add_h1(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h1(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_h2(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h2(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_h3(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h3(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_h4(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h4(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_h5(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h5(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_h6(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_h6(Lipsum.generate_lipsum_text(1)).save(
    ...
    def test_add_image(self):
        A42ColumnPortraitTemplate().add_image(
    ...
    def test_linechart(self):
        A42ColumnPortraitTemplate().add_linechart(
    ...
    def test_add_map_of_europe(self):
        A42ColumnPortraitTemplate().add_map_of_europe(marked_countries=["Poland"]).save(
    ...
    def test_add_map_of_the_contiguous_united_states(self):
        A42ColumnPortraitTemplate().add_map_of_the_contiguous_united_states(
            marked_states=["Texas"]
    ...
    def test_add_map_of_the_united_states(self):
        A42ColumnPortraitTemplate().add_map_of_the_united_states(
            marked_states=["Texas"]
    ...
    def test_add_map_of_the_world(self):
        A42ColumnPortraitTemplate().add_map_of_the_world(
    ...
    def test_add_ordered_list(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_ordered_list(
            [
    ...
    def test_add_piechart(self):
        A42ColumnPortraitTemplate().add_piechart(
            xs=[10, 20, 30, 40],
            labels=["lorem", "ipsum", "dolor", "sit"],
    ...
    def test_add_qr_code(self):
        A42ColumnPortraitTemplate().add_qr_code("https://www.borbpdf.com/").save(
    ...
    def test_add_quote(self):
        A42ColumnPortraitTemplate().add_quote(
    ...
    def test_add_table(self):
        A42ColumnPortraitTemplate().add_table(
            tabular_data=[
                ["", "Lorem", "Ipsum", "Dolor"],
                [2001, 0, 1, 20],
                [2002, 1, 34, 34],
    ...
    def test_add_text(self):
        random.seed(0)
        A42ColumnPortraitTemplate().add_text(Lipsum.generate_lipsum_text(3)).add_text(
    ...
    def test_add_code(self):
        A42ColumnPortraitTemplate().add_code(
