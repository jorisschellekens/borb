...
class TestAddOrderedList(TestCase):
    def test_add_ordered_list_001(self):
        A4PortraitTemplate().add_ordered_list(["Lorem", "Ipsum", "Dolor", "Sit"]).save(
            self.get_first_output_file()
        )
        self.compare_visually_to_ground_truth(self.get_first_output_file())

    def test_add_ordered_list_002(self):
