...
logging.basicConfig(
    filename=Path(get_log_dir(), "test-add-strike-out-annotation.log"),
    level=logging.DEBUG,
)
...
class TestAddStrikeOutAnnotation(unittest.TestCase):
    def __init__(self, methodName="runTest"):
        ...
        self.output_file = Path(
            get_output_dir(), "test-add-strike-out-annotation/output.pdf"
        )
    ...
    def test_add_strike_out_annotation(self):
        ...
        # add annotation
        doc.get_page(0).append_strike_out_annotation(
