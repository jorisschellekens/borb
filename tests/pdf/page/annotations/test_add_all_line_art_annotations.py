...
logging.basicConfig(
    filename="../../../logs/test-add-all-line-art-annotation.log", level=logging.DEBUG
)


class TestAddAllLineArtAnnotations(Test):
    def __init__(self, methodName="runTest"):
        super().__init__(methodName)
        self.output_dir = Path("../../../output/test-add-all-line-art-annotation")

    def test_exact_document(self):
        self.test_document(Path("/home/joris/Code/pdf-corpus/0203.pdf"))

    def test_corpus(self):
        super(TestAddAllLineArtAnnotations, self).test_corpus()
