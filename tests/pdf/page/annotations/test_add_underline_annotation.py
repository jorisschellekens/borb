...
class TestAddUnderlineAnnotation(unittest.TestCase):
    ...
    def test_write_document(self):
        ...
        layout.add(
            ...
            .add(
                Paragraph(
                    "This test creates a PDF with an empty Page, and a Paragraph of text. A subsequent test will add an underline annotation."
                )
            )
