...
logging.basicConfig(
    filename="../annotations/test-add-highlight-annotation.log", level=logging.DEBUG
)


class TestAddHighlightAnnotation(Test):
    def __init__(self, methodName="runTest"):
        super().__init__(methodName)
        self.output_dir = Path("../annotations/add-highlight-annotations")

    def test_exact_document(self):
        self.test_document(Path("/home/joris/Code/pdf-corpus/0203.pdf"))

    def test_corpus(self):
        super(TestAddHighlightAnnotation, self).test_corpus()
