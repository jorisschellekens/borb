...
class TestProgressSquare(unittest.TestCase):
    ...
    def test_progress_square_padding_left(self):
        ...
        PDF.write(what=d, where_to=f"assets/test_progress_square_padding_left.pdf")
    ...
    def test_progress_square_padding_top(self):
        ...
        PDF.write(what=d, where_to=f"assets/test_progress_square_padding_top.pdf")
    ...
    def test_progress_square_padding_right(self):
        ...
        PDF.write(what=d, where_to=f"assets/test_progress_square_padding_right.pdf")
    ...
    def test_progress_square_padding_bottom(self):
        ...
        PDF.write(what=d, where_to=f"assets/test_progress_square_padding_bottom.pdf")
