...
class TestVerticalBulletListFontSize(unittest.TestCase):
    ...
    def test_vertical_bullets_list_font_size_small(self):
        ...
        PDF.write(
            what=d, where_to="assets/test_vertical_bullets_list_font_size_small.pdf"
        )
    ...
    def test_vertical_bullets_list_font_size_regular(self):
        ...
        PDF.write(
            what=d, where_to="assets/test_vertical_bullets_list_font_size_regular.pdf"
        )
    ...
    def test_vertical_bullets_list_font_size_large(self):
        ...
        PDF.write(
            what=d, where_to="assets/test_vertical_bullets_list_font_size_large.pdf"
        )
